...
<body <?php body_class(); ?>>
    <?php
    $whichHeader = get_field("header", "option");
...
?>
    ...
    ?>
        ...
        <?php
            ...
            if ($whichHeader === "Boilerplate header") :
        ?>
        <header style="margin-top:-80px" id="custom-header">

            <?php echo do_shortcode('[et_pb_section global_module="79"][/et_pb_section]'); ?>
